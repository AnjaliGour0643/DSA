...
class DoublyLinkedList {
    ...
    insertAtPosition(data, position) {
        ...
        if (index === position) {
            if (!current) {
                this.insertAtEnd(data); // If current is null, insert at the end
                return;
            }
    ...
    deleteFromBeginning() {
        ...
        if (this.head) this.head.prev = null; // Update the previous of new head
    }
    ...
    deleteFromEnd() {
        ...
        current.prev.next = null; // Unlink the last node
    }
...
function getUserInput() {
    ...
    while (true) {
        ...
        console.log("7. Traverse Forward");
        console.log("8. Traverse Backward");
